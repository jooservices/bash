...
sudo apt -y install php8.1-cli php8.1-curl php8.1-igbinary php8.1-intl php8.1-mbstring php8.1-mcrypt php8.1-xml php8.1-xmlrpc php8.1-xsl php8.1-yaml php8.1-zip
sudo apt -y install php8.1-gd php8.1-imagick imagemagick
